...
@Configuration
@MapperScan(basePackages = {"com.company.mybatis.dao.master"}, sqlSessionFactoryRef = "masterSqlSessionFactory")
@Slf4j
public class DataSourceMasterConfig {
    /**
     * mapper.xml文件路径，必须与其他SqlSessionFactory-mapper路径区分.
     */
    public final static String MAPPER_XML_PATH = "classpath*:mapper/master/*.xml";
